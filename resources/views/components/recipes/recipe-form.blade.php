...
<label for="description">Beschrijving</label><textarea class="autoResizeTextArea" name="description">{{$fields->description}}</textarea><br><br>
...
<label for="ingredients">Ingredienten</label><textarea class="autoResizeTextArea" type="text" name="ingredients">{{$fields->ingredients}}</textarea><br><br>
